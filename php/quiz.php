        ...
        <form action="quiz.php" method="POST">
           ...
           // var_dump($_SESSION ['selectedQuestions']);
            if($_SESSION['frageCount']<$nrQuestion){
                ...
                echo "</div>";
                echo '<input type="submit" id="QuizBtn" class="Buttton" value="Nächste Frage">';
                echo "<button class='Buttton' id='QuizBtn' onClick=\"window.location.href='quizauswahl.php'; return false;\">Abbrechen</button>";
            }
            else{
